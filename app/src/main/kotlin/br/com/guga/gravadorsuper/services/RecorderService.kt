package br.com.guga.gravadorsuper.services
...
import br.com.guga.gravadorsuper.extensions.getFormattedFilename
...
import br.com.guga.gravadorsuper.helpers.RECORDING_RUNNING
import br.com.guga.gravadorsuper.helpers.RECORDING_STOPPED
import br.com.guga.gravadorsuper.helpers.STOP_AMPLITUDE_UPDATE
import br.com.guga.gravadorsuper.helpers.TOGGLE_PAUSE
import br.com.guga.gravadorsuper.models.Events
import br.com.guga.gravadorsuper.recorder.MediaRecorderWrapper
import br.com.guga.gravadorsuper.recorder.Mp3Recorder
import br.com.guga.gravadorsuper.recorder.WavRecorder
import br.com.guga.gravadorsuper.recorder.Recorder
    ...
    private fun startRecording() {
        ...
        try {
            recorder = when {
                ...
                config.extension == EXTENSION_WAV -> WavRecorder(this)
