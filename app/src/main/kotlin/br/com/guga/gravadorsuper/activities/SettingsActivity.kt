...
import br.com.guga.gravadorsuper.databinding.ActivitySettingsBinding
import br.com.guga.gravadorsuper.dialogs.FilenamePatternDialog
import br.com.guga.gravadorsuper.dialogs.MoveRecordingsDialog
import br.com.guga.gravadorsuper.extensions.config
import br.com.guga.gravadorsuper.extensions.deleteTrashedRecordings
import br.com.guga.gravadorsuper.extensions.getAllRecordings
import br.com.guga.gravadorsuper.extensions.hasRecordings
import br.com.guga.gravadorsuper.extensions.launchFolderPicker
import br.com.guga.gravadorsuper.helpers.BITRATES
import br.com.guga.gravadorsuper.helpers.DEFAULT_BITRATE
import br.com.guga.gravadorsuper.helpers.DEFAULT_SAMPLING_RATE
import br.com.guga.gravadorsuper.helpers.EXTENSION_M4A
import br.com.guga.gravadorsuper.helpers.EXTENSION_MP3
import br.com.guga.gravadorsuper.helpers.EXTENSION_OGG
import br.com.guga.gravadorsuper.helpers.EXTENSION_WAV
import br.com.guga.gravadorsuper.helpers.SAMPLING_RATES
import br.com.guga.gravadorsuper.helpers.SAMPLING_RATE_BITRATE_LIMITS
...
class SettingsActivity : SimpleActivity() {
    ...
    private fun updateBitrateVisibility() {
        binding.settingsBitrateHolder.beVisibleIf(config.extension != EXTENSION_WAV)
    }
    ...
    private fun setupExtension() {
        ...
        binding.settingsExtensionHolder.setOnClickListener {
            val items = arrayListOf(
                ...
                RadioItem(EXTENSION_WAV, getString(R.string.wav_pcm))
            )
